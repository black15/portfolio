...
const Services = (props: Props) => {
  return (
		<section id='services' className='relative flex flex-col my-32 lg:my-24'>
			<h1 className="text-center absolute right-0 left-0 mx-auto text-5xl sm:text-7xl lg:text-9xl text-[#0000002c] dark:text-[#ffffff0e] font-bold animate__animated animate__fadeInUp -z-10">SERVICES</h1>
			<h2 className="text-2xl md:text-3xl text-center font-bold z-10 uppercase animate__animated animate__fadeInUp pt-6 lg:pt-10">W<span className='border-b-4 border-[#009945]'>hat I Offer</span> ?</h2>
