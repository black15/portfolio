		...
		<section id='projects' className='relative flex flex-col my-32 lg:my-24'>
			...
			<div className="flex flex-wrap justify-around items-center space-y-12 mt-24">
				<div className="relative mt-12">
					<div className="absolute inset-0 z-10 bg-gray-500 text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-90 duration-300 hover:text-gray-200">
